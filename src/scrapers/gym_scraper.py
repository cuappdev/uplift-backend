...
#             try:
#                 hour = (
#                     db_session.query(OpenHours)
#                     .filter(
#                         OpenHours.facility_id == facility.id,
#                         OpenHours.day == i,
#                         OpenHours.start_time == st_obj.time(),
#                         OpenHours.end_time == end_obj.time(),
#                     )
#                     .first()
#                 )
...
#                 hour = OpenHours(
#                     facility_id=facility.id, day=i, start_time=st_obj.time(), end_time=end_obj.time(), restrictions=[]
#                 )
#                 db_session.add(hour)
#                 db_session.commit()

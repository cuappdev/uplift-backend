...
# from utils.constants import CAPACITY_SCRAPE_PATH, CAPACITY_SCRAPE_INTERVAL_MINUTES
# from src.database import db_session
# from src.models.facility import Facility
# from src.models.capacity import Capacity
# from src.utils.utils import parse_c2c_datetime
# import time
...
#                     and_(Capacity.facility_id == facility_id, Capacity.updated == last_updated)
#                 ).first()
#             ):
#                 new_capacity = Capacity(facility_id=facility_id, count=count, percent=percent, updated=last_updated)
